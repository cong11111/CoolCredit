 ...
 */
public class ClearEditText2 extends EmailAutoCompleteTextView implements View.OnFocusChangeListener,TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(R.mipmap.btn_clear);
        }
